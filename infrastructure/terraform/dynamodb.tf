# TODO: Remove this table after migration to separate prediction and model state
# tables is complete.
...
resource "aws_dynamodb_table" "bayesbet_model_state" {
  name         = "${var.project}-model-state-${var.env}"
  billing_mode = "PAY_PER_REQUEST"
  hash_key     = "league"
  range_key    = "prediction_date"
